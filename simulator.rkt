...
; simulator.rkt
; Simula un automata finito determinista (DFA) representado como hash.
; Sigue el patron del esqueleto automata_simulation_2026 pero en paradigma
; funcional: la validacion es recursiva en lugar de iterativa.
;
; El hash del automata tiene la estructura producida por desc-rec.rkt:
;   "q0"      -> (hash "a" "q1" "b" "q1")  ; transiciones
;   "inicial" -> "q0"
;   "finales" -> (list "q2")
;   "check"   -> (list "'ab'" "'b'" ...)
;
...
; -----------------------------------------------------------------------
; simular-paso: hash string int string list -> string
...
; -----------------------------------------------------------------------
; simular-cadena: hash string -> string
